 ...
 * Custom柱状图渲染器
 */
public class MBarChartRenderer extends BarChartRenderer {
    ...
    public MBarChartRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
